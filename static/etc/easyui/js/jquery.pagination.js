...
(function ($) {
    function _1(_2) {
        ...
        var _5 = {
            first: {
                iconCls: "easyui-pagination-first", handler: function () {
                    if (_4.pageNumber > 1) {
                        _d(_2, 1);
                    }
                }
            }, prev: {
                iconCls: "easyui-pagination-prev", handler: function () {
                    if (_4.pageNumber > 1) {
                        _d(_2, _4.pageNumber - 1);
                    }
                }
            }, next: {
                iconCls: "easyui-pagination-next", handler: function () {
                ...
                iconCls: "easyui-pagination-last", handler: function () {
                ...
                iconCls: "easyui-pagination-load", handler: function () {
        ...
        var _8 = $(_2).addClass("easyui-pagination").html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>");
        var tr = _8.find("tr");
...
// var a=$("<a href=\"javascript:void(0)\"></a>").appendTo(tr);
            var a;
            if ("first" == _a) {
                a = $("<a href=\"javascript:void(0)\">首页</a>").appendTo(tr);
            } else if ("prev" == _a) {
                a = $("<a href=\"javascript:void(0)\">上一页</a>").appendTo(tr);
            } else if ("next" == _a) {
                a = $("<a href=\"javascript:void(0)\">下一页</a>").appendTo(tr);
            } else if ("last" == _a) {
                a = $("<a href=\"javascript:void(0)\">末页</a>").appendTo(tr);
            } else if ("refresh" == _a) {
                a = $("<a href=\"javascript:void(0)\">刷新</a>").appendTo(tr);
            } else {
            ...
            a.linkbutton({
                ...
                plain: true
            }).unbind(".easyui-pagination").bind("click.easyui-pagination", _5[_a].handler);
            return a;
        };
        if (_4.showPageList) {
            var ps = $("<select class=\"easyui-pagination-page-list\"></select>");
            ...
            $("<td><div class=\"easyui-pagination-btn-separator\"></div></td>").appendTo(tr);
        }
        bb.first = _9("first");
        bb.prev = _9("prev");
        $("<td><div class=\"easyui-pagination-btn-separator\"></div></td>").appendTo(tr);
        $("<span style=\"padding-left:6px;\"></span>").html(_4.beforePageText).appendTo(tr).wrap("<td></td>");
        bb.num = $("<input class=\"easyui-pagination-num\" type=\"text\" value=\"1\" size=\"2\">").appendTo(tr).wrap("<td></td>");
        bb.num.unbind(".easyui-pagination").bind("keydown.easyui-pagination", function (e) {
            if (e.keyCode == 13) {
        ...
        $("<div class=\"easyui-pagination-info\"></div>").appendTo(_8);
    ...
    function _11(_12, _13) {
        ...
        $.extend(_14, _13 || {});
        var ps = $(_12).find("select.easyui-pagination-page-list");
        if (ps.length) {
            ps.val(_14.pageSize + "");
        ...
        $(_12).find("div.easyui-pagination-info").html(_16);
    ...
    function _17(_18, _19) {
        ...
        if (_1a.showRefresh) {
            if (_1a.loading) {
                bb.refresh.linkbutton({iconCls: "easyui-pagination-loading"});
            } else {
                bb.refresh.linkbutton({iconCls: "easyui-pagination-load"});
            }
        }
    };
    $.fn.easyui_pagination = function (_1b, _1c) {
        if (typeof _1b == "string") {
            return $.fn.easyui_pagination.methods[_1b](this, _1c);
        }
        _1b = _1b || {};
        return this.each(function () {
            ...
            if (_1e) {
                ...
                _1d = $.extend({}, $.fn.easyui_pagination.defaults, $.fn.easyui_pagination.parseOptions(this), _1b);
    ...
    $.fn.easyui_pagination.parseOptions = function (_21) {
        var t = $(_21);
