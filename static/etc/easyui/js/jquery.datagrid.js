...
(function ($) {
        ...
        if (_3f.pagination) {
            ...
            _46.easyui_pagination({
                ...
                onSelectPage: function (_48, _49) {
                    _3f.pageNumber = _48;
                    _3f.pageSize = _49;
                    _46.easyui_pagination("refresh", {pageNumber: _48, pageSize: _49});
                    _13b(_3d);
                }
            });
            _3f.pageSize = _46.easyui_pagination("options").pageSize;
        }
    ...
    function _9e(_9f, _a0) {
        ...
        if (_a5.length) {
            if (_a5.easyui_pagination("options").total != _a0.total) {
                _a5.easyui_pagination("refresh", {total: _a0.total});
            }
        }
        _1b(_9f);
        dc.body2.triggerHandler("scroll");
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            if (_190.length) {
                var _191 = _190.easyui_pagination("options");
            ...
            return jq.each(function () {
                ...
                _196.easyui_pagination({pageNumber: 1});
                _13b(this, _195);
            });
            ...
            return jq.each(function () {
                var opts = $.data(this, "datagrid").options;
                $(this).datagrid("getPager").easyui_pagination("loading");
                if (opts.loadMsg) {
            ...
            return jq.each(function () {
                $(this).datagrid("getPager").easyui_pagination("loaded");
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        nowrap: true,
        idField: null,
        url: null, /*loadMsg:"Processing, please wait ...",*/
        rownumbers: false,
        singleSelect: false,
        selectOnCheck: true,
        checkOnSelect: true,
