...
var navTab = {
	...
	_getTabs: function() {
		//console.log('this._tabBox-------------')
		//console.log(this._tabBox)
		return this._tabBox.find("> li");
	},
	_getPanels: function() {
		//console.log('_getPanels')
    //console.log(this._panelBox)
	...
	_getLeft: function() {
    //console.log(this._tabBox) // 有
    //console.log(this._tabBox.position()) // null
